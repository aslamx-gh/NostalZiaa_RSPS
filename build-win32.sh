...
cp native/build-x86/src/Release/NostalZiaa.exe build/win-x86/
cp build/libs/NostalZiaa.jar build/win-x86/
...
echo NostalZiaa.exe 32bit sha256sum
sha256sum build/win-x86/NostalZiaa.exe

dumpbin //HEADERS build/win-x86/NostalZiaa.exe

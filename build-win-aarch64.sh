...
sha256sum build/libs/NostalZiaa.jar
...
cp native/build-aarch64/src/Release/NostalZiaa.exe build/win-aarch64/
cp build/libs/NostalZiaa.jar build/win-aarch64/
...
echo NostalZiaa.exe aarch64 sha256sum
sha256sum build/win-aarch64/NostalZiaa.exe

dumpbin //HEADERS build/win-aarch64/NostalZiaa.exe

...
chmod 644 build/libs/NostalZiaa.jar

cp native/build-x64/src/NostalZiaa build/linux-x64/
cp build/libs/NostalZiaa.jar build/linux-x64/
...
ln -s NostalZiaa AppRun

# Ensure NostalZiaa is executable to all users
chmod 755 NostalZiaa
popd

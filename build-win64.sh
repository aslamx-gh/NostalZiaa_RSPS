...
cp native/build-x64/src/Release/NostalZiaa.exe build/win-x64/
cp build/libs/NostalZiaa.jar build/win-x64/
...
echo NostalZiaa.exe 64bit sha256sum
sha256sum build/win-x64/NostalZiaa.exe

dumpbin //HEADERS build/win-x64/NostalZiaa.exe
